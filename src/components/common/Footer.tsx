...
// Multi-colour Gmail logo (the transparent envelope body shows the chip's white background).
const GmailIcon = ({ size = 24, ...props }: any) => (
...
const contacts = [
  ...
  },
  {
    ...
    // Gmail logo carries its own colours.
  },
];
